...
//  Map Hackwich
//
//  Created by Jack Kamaryt on 2/8/23.
//
...
struct ContentView: View {
    ...
    func findLocation(name: String) {
        locationManager.geocoder.geocodeAddressString(name) { (placemarks, error) in guard placemarks != nil else { print("Could not locate \(name)")
            return
        }
